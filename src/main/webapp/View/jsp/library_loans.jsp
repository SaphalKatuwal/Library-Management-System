  ...
  <style>
    ...
    * {
    ...
    @media (max-width: 900px) {
      .loans-section { padding: 32px 10px; }
  ...
  <div class="navbar-left">
    ...
    <nav class="navbar-links">
      ...
      <c:if test="${sessionScope.user != null && sessionScope.user.role == 'admin'}">
        ...
        <a href="${pageContext.request.contextPath}/library_loans" class="active">Library Loans</a>
  ...
  <main class="content">
    <div class="main-content">
      <div class="loans-section">
        <h2><i class="fas fa-book-open"></i> Library Loans</h2>
        <!-- Borrowings are now handled in dashboard.jsp -->
      </div>
    </div>
  </main>
  <footer>
